...
def train():
    ...
    device_ids, batch_size, lr, weight_decay, epochs = [0, 1, 2, 3], 128, 5e-2, 0, 1000  # lr = 5e-2, 1e-2
    kwargs = {
        'data_name': data_name, 'model_name': 'li_conductance', 'batch_size': batch_size, 'seed': 42,  # 11, 42
