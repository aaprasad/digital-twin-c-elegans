...
if __name__ == '__main__':
    ...
    # )
    preprocess_and_split_dataset(
        load_name='data_14000_640.pt',
        save_names=[
            'data_14000_10000_640_64_train.pt',
            'data_14000_2000_640_64_eval.pt',
            'data_14000_2000_640_64_test.pt'
        ],
        lengths=[10000, 2000, 2000], seq_len=64, seed=33
    )
