from virtual_nematode.data.utils import (
    preprocess_and_split_dataset, preprocess_and_split_slide_dataset, preprocess_and_split_slide_sample_dataset
)
...
if __name__ == '__main__':
    ...
    # preprocess_and_split_slide_sample_dataset(
    #     load_name='data_7000_640.pt',
    #     save_names=[
    #         'data_7000_5000_640_64_stride8_50000_train.pt',
    #         'data_7000_1000_640_64_stride8_10000_eval.pt',
    #         'data_7000_1000_640_64_stride8_10000_test.pt'
    #     ],
    #     lengths=[5000, 1000, 1000], x_index=[(4, 28), (63, 64)],  # proprioception, gradient
    #     seq_len=64, seq_range=640, seq_amount=10, stride=8, seed=33
    # )
    # preprocess_and_split_slide_sample_dataset(
    #     load_name='data_7000_640.pt',
    #     save_names=[
    #         'data_7000_5000_320_64_stride8_50000_train.pt',
    #         'data_7000_1000_320_64_stride8_10000_eval.pt',
    #         'data_7000_1000_320_64_stride8_10000_test.pt'
    #     ],
    #     lengths=[5000, 1000, 1000], x_index=[(4, 28), (63, 64)],  # proprioception, gradient
    #     seq_len=64, seq_range=320, seq_amount=10, stride=8, seed=33
    # )
    # preprocess_and_split_dataset(
