...
if __name__ == '__main__':
    ...
    preprocess_and_split_slide_sample_dataset(
        load_name='data_7000_640.pt',
        save_names=[
            'data_7000_640_256_stride8_n10_train.pt',
            'data_7000_640_256_stride8_n10_eval.pt',
            'data_7000_640_256_stride8_n10_test.pt'
        ],
        lengths=[5000, 1000, 1000], x_index=[(4, 28), (63, 64)],  # proprioception, gradient
        seq_len=64, seq_range=256, seq_amount=10, stride=8, seed=33
    )
    preprocess_and_split_slide_sample_dataset(
        load_name='data_7000_640.pt',
        save_names=[
            'data_7000_640_512_stride8_n10_train.pt',
            'data_7000_640_512_stride8_n10_eval.pt',
            'data_7000_640_512_stride8_n10_test.pt'
        ],
        lengths=[5000, 1000, 1000], x_index=[(4, 28), (63, 64)],  # proprioception, gradient
        seq_len=64, seq_range=512, seq_amount=10, stride=8, seed=33
    )
    # preprocess_and_split_dataset(
