...
def fully_connected():
    ...
    train_eval_test(
        ...
        cuda=0, device_ids=[0, 1, 2, 3], lr=0.001, weight_decay=0, epochs=300, early_stop=30, comment='', loss='MSESymmetricMuscleLoss',
        # model kwargs
        units=100, output_dim=96, in_features=193, output_mapping='affine'
    )
