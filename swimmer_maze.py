...
def make_swimmer(n_bodies, joint_range, body_len, perimeter_width, box_width, camera_pos):
    """ create swimmer env """
    # generate xml str
...
def test_random():
    ...
    env = make_swimmer(n_bodies=12, joint_range='-30 30', body_len=0.26, perimeter_width=6, box_width=0.5, camera_pos='0 -6 6')
