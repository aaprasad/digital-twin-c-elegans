...
def generate_dataset(distance=15, data_size=6000, seed=42, max_episode_steps=2500):
    ...
    torch.save(dataset, 'data/chemotaxis.pt')


if __name__ == '__main__':
    generate_dataset(data_size=6000, max_episode_steps=2500)
