...
def generate_dataset(
    env, model, action_func, x_func, y_func, input_size, action_size, data_size, max_episode_steps, seed,
    num_workers=None, disable=False
):
    """ generate forward movement dataset
    input_size: x size
    """
    dataset = SimulationDataset(
        data_size, max_episode_steps, input_size, action_size, seed, generate_sample, num_workers, disable,
