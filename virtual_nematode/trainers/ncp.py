...
from virtual_nematode.networks.snn.lif_chemotaxis import (
    ...
    LeakyIntegratorConductanceBasedRestrainedGradientInput,
...
def prepare_model(model_name, device=None, device_ids=None, model_path=None, strict=True, **kwargs):
    ...
    **kwargs: kwargs for initializing model
    ...
    elif model_name == 'li_conductance_restrained_gradient':
        model = li_conductance_restrained_gradient(**kwargs)
    elif model_name == 'li_conductance_restrained_gradient1':
        model = li_conductance_restrained_gradient1(**kwargs)
    elif model_name == 'li_conductance_restrained_gradient2':
        model = li_conductance_restrained_gradient2(**kwargs)
    elif model_name == 'lig0':
        model = lig0(**kwargs)
    ...
    elif model_name == 'lic2':
        model = SNN(cell=LIC2(**kwargs))
    elif model_name == 'lic3':
        model = SNN(cell=LIC3(**kwargs))
    elif model_name == 'lic4':
        model = SNN(cell=LIC4(**kwargs))
    elif model_name == 'lic5':
        model = SNN(cell=LIC5(**kwargs))
    elif model_name == 'lic11':
        model = SNN(cell=LIC11(**kwargs))
    elif model_name == 'lic20':
        model = SNN(cell=LIC20(**kwargs))
    elif model_name == 'lic21':
        model = SNN(cell=LIC21(**kwargs))
    elif model_name == 'lic22':
        model = SNN(cell=LIC22(**kwargs))
    elif model_name == 'lic30':
    ...
    elif model_name == 'lic61':
        model = SNN(cell=LIC61(**kwargs))
    elif model_name == 'lic62':
        model = SNN(cell=LIC62(**kwargs))
    elif model_name == 'lic70':
        model = SNN(cell=LIC70(**kwargs))
    elif model_name == 'lic71':
        model = SNN(cell=LIC71(**kwargs))
    elif model_name == 'lic72':
        model = SNN(cell=LIC72(**kwargs))
    elif model_name == 'lic73':
        model = SNN(cell=LIC73(**kwargs))
    elif model_name == 'lic80':
        model = SNN(cell=LIC80(**kwargs))
    elif model_name == 'lic81':
        model = SNN(cell=LIC81(**kwargs))
    elif model_name == 'lic82':
        model = SNN(cell=LIC82(**kwargs))
    elif model_name == 'lic90':
        model = SNN(cell=LIC90(**kwargs))
    elif model_name == 'lic91':
        model = SNN(cell=LIC91(**kwargs))
    elif model_name == 'lic92':
        model = SNN(cell=LIC92(**kwargs))
    elif model_name == 'lic93':
        model = SNN(cell=LIC93(**kwargs))
...
def li_conductance_gradient1(**kwargs):
    cell = LeakyIntegratorConductanceBasedGradientInput1(**kwargs)
    model = SNN(cell)
    return model
...
def li_conductance_restrained_gradient(**kwargs):
    cell = LeakyIntegratorConductanceBasedRestrainedGradientInput(**kwargs)
    model = SNN(cell)
    return model


def li_conductance_restrained_gradient1(**kwargs):
    cell = LeakyIntegratorConductanceBasedRestrainedGradientInput1(**kwargs)
    model = SNN(cell)
    return model


def li_conductance_restrained_gradient2(**kwargs):
    cell = LeakyIntegratorConductanceBasedRestrainedGradientInput2(**kwargs)
    model = SNN(cell)
    return model
...
def li_conductance_mixed_gradient(**kwargs):
    cell = LeakyIntegratorConductanceBasedMixedGradientInput(**kwargs)
    model = SNN(cell)
    return model
