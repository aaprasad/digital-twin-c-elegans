...
def make_swimmer(n_bodies=12, joint_range='-100 100', body_len=0.25, perimeter_width=6, camera_pos='0 -6 6', camera_z=None, max_episode_steps=1000, seed=None):
    """ create swimmer env """
    # generate xml str
    ...
    xml_str = forage(xml_str=xml_str, perimeter_width=perimeter_width, seed=seed)
