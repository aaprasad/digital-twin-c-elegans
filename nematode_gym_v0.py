...
def make_nematode(joint_range, body_len, muscle_len, arrangement=None, camera_pos=None, camera_z=None):
    """ create nematode env """
    # generate xml str
    xml_folder = 'src/envs/mujoco/assets/'
    xml_str = nematode(joint_range=joint_range, body_len=body_len, muscle_len=muscle_len, xml_file=os.path.join(xml_folder, 'swimmer.xml'), arrangement=arrangement, camera_pos=camera_pos, camera_z=camera_z)
