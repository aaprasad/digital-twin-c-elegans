...
def _make_model(n_bodies, joint_range, body_len, muscle_len, xml_file, camera_pos=None):
...
def swimmer(n_bodies, joint_range, body_len, muscle_len, xml_file, camera_pos=None):
    mjcf = _make_model(n_bodies=n_bodies, joint_range=joint_range, body_len=body_len, muscle_len=muscle_len, xml_file=xml_file, camera_pos=camera_pos)
