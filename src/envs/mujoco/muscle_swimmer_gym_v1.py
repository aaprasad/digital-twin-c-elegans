...
def _make_model(n_bodies, joint_range, xml_file, camera_pos=None, camera_z=None):
...
def swimmer(n_bodies, joint_range, xml_file, camera_pos=None, camera_z=None):
    mjcf = _make_model(n_bodies=n_bodies, joint_range=joint_range, xml_file=xml_file, camera_pos=camera_pos, camera_z=camera_z)
